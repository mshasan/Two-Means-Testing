...
class blk trt; model y = trt/ddfm=kemwardroger; repeated / type = un subject = blk; run;
*ods listing;
...
RESET STORAGE = "Paper";
	LOAD result;
create abcd.power1 var _All_;
append;
quit;

proc transpose data=abcd.power1 out=abcd.power_1;
run;
